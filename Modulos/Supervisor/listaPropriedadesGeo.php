...
<html>
    <head>
        ...
        <script>
<?php require_once '../Supervisor/geraMarkersProps.php'; ?>
        </script>
    </head>
    <body>
        <div id='map'></div>
        <script>
            ...
            L.control.layers({
                'Ruas': L.mapbox.styleLayer('mapbox://styles/mapbox/streets-v11').addTo(map),
                'Leve': L.mapbox.styleLayer('mapbox://styles/mapbox/light-v10'),
                'Outdoors': L.mapbox.styleLayer('mapbox://styles/mapbox/outdoors-v11'),
                'Satelite': L.mapbox.styleLayer('mapbox://styles/mapbox/satellite-v9'),
                'Ruas-Satelite': L.mapbox.styleLayer('mapbox://styles/mapbox/satellite-streets-v11')
            }, {
                'PROPRIEDADES': propriedades,
                'ESCOLAS': ensino,
                'UNIDADES DE SAÚDE': ubs,
                'FESTEJOS JUNINOS': festas,
                'POSTOS DE COMBUSTÍVEIS': postos,
                'QUILOMBOS': povoados,
                'DISTRITOS': distritos,
                'INSTITUIÇÕES FINANCEIRAS': finac,
                'CÂMERAS': cameras,
                'CVLI - 2020': corpo2020,
                'CVLI - 2021': corpo2021,
                'CVLI - 2022': corpo2022,
                'CVLI - 2023': corpo2023,
                'CENTRO INDUSTRIAL': cerco92,
                'OPM / BASES DA 92CIPM ': vtrbs,
                'OPM / BASES NA ÁREA DA 77CIPM ': vtrbs77,
                'OPM / BASES NA ÁREA DA 78CIPM ': vtrbs78,
                'Locais de Votação 92CIPM - 1º pelotão': undtre,
                'Locais de Votação 92CIPM - 2º pelotão': urnas2pel,
                'Locais de Votação 92CIPM - 3º pelotão': urnas3pel,
                'Locais de Votação 92CIPM - 4º pelotão': urnas4pel
            }).addTo(map);
