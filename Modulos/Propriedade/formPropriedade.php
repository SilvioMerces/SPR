    ...
    function posicionaMarkerProp() {
        ...
        switch (icon) {
            ...
            case '9':
                ...
                break;
            case '14':
                marker = L.marker([latitude, longitude], {icon: icon_77cipm, draggable: true,autoPan: true}).on('dragend', function (e) {
                    document.getElementById('lat').value = e.target.getLatLng().lat.toString();
                    document.getElementById('log').value = e.target.getLatLng().lng.toString();
                }).bindPopup("Propriedade: " + nomeProp);
                break;
            case '15':
                marker = L.marker([latitude, longitude], {icon: icon_78cipm, draggable: true,autoPan: true}).on('dragend', function (e) {
                    document.getElementById('lat').value = e.target.getLatLng().lat.toString();
                    document.getElementById('log').value = e.target.getLatLng().lng.toString();
                }).bindPopup("Propriedade: " + nomeProp);
                break;
            case '16':
                marker = L.marker([latitude, longitude], {icon: ubsIcon, draggable: true,autoPan: true}).on('dragend', function (e) {
                    document.getElementById('lat').value = e.target.getLatLng().lat.toString();
                    document.getElementById('log').value = e.target.getLatLng().lng.toString();
                }).bindPopup("Propriedade: " + nomeProp);
                break;
            case '17':
                marker = L.marker([latitude, longitude], {icon: festasIcon, draggable: true,autoPan: true}).on('dragend', function (e) {
                    document.getElementById('lat').value = e.target.getLatLng().lat.toString();
                    document.getElementById('log').value = e.target.getLatLng().lng.toString();
                }).bindPopup("Propriedade: " + nomeProp);
                break;
            case '18':
                marker = L.marker([latitude, longitude], {icon: icon_cruz, draggable: true,autoPan: true}).on('dragend', function (e) {
                    document.getElementById('lat').value = e.target.getLatLng().lat.toString();
                    document.getElementById('log').value = e.target.getLatLng().lng.toString();
                }).bindPopup("Propriedade: " + nomeProp);
                break;
...
<div class="col col-2" >
    <form action="Modulos/Propriedade/ctrl_propriedade.php" method="POST" enctype="Multipart/form-data" id='frm_propriedade' onsubmit="return false;"  >
        ...
        <div class="col col-2">
            <span>
                ...
                <select id="tipoprop" name="tipoprop" onchange="posicionaMarkerProp()" required>
                    ...
                    <option <?php if($Prop->getTipoprop()==16) echo 'selected';?> value=16>Unidades de Saúde</option>
                    <option <?php if($Prop->getTipoprop()==3) echo 'selected';?> value=3>Postos de Combustível</option>
                    <option <?php if($Prop->getTipoprop()==4) echo 'selected';?> value=4>Quilombolas</option>
                    ...
                    <option <?php if($Prop->getTipoprop()==8) echo 'selected';?> value=8>Base de Policial 92CIPM</option>
                    <option <?php if($Prop->getTipoprop()==9) echo 'selected';?> value=9>Urnas Eleitorais</option>
                    <option <?php if($Prop->getTipoprop()==13) echo 'selected';?> value=13>Centro Industrial</option>
                    <option <?php if($Prop->getTipoprop()==14) echo 'selected';?> value=14>Base de Policial 77CIPM</option>
                    <option <?php if($Prop->getTipoprop()==15) echo 'selected';?> value=15>Base de Policial 78CIPM</option>
                    <option <?php if($Prop->getTipoprop()==17) echo 'selected';?> value=17>Festejos Juninos</option>
                    <option <?php if($Prop->getTipoprop()==18) echo 'selected';?> value=18>CVLI - 2020</option>
                    <option <?php if($Prop->getTipoprop()==19) echo 'selected';?> value=19>CVLI - 2021</option>
                    <option <?php if($Prop->getTipoprop()==20) echo 'selected';?> value=20>CVLI - 2022</option>
                    <option <?php if($Prop->getTipoprop()==21) echo 'selected';?> value=21>CVLI - 2023</option>
                </select>
            </span>
        ...
        <div class="col col-2">
            ...
            <span><label for="defencivo">Usa Defensivo agricola?</label><input type="radio" id="defensivo" name="defensivo" value="true" />Sim<input type="radio" id="defensivo" name="defensivo" value="false" />Não</span>
...
?>
    ...
    var pin_blue = new LeafIcon({iconUrl: '../Templates/imgs/pin_blue.svg'}),
            ...
            icon_77cipm = new LeafIcon({iconUrl: '../Templates/imgs/icon_77cipm.svg'}),
            icon_78cipm = new LeafIcon({iconUrl: '../Templates/imgs/icon_78cipm.svg'}),
            ubsIcon = new LeafIcon({iconUrl: '../Templates/imgs/icon_ubs.svg'}),
            icon_cruz = new LeafIcon({iconUrl: '../Templates/imgs/icon_cruz.svg'}),
            fogueira = new LeafIcon({iconUrl: '../Templates/imgs/fogueira.svg'}),
